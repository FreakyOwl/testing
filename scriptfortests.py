...
with urllib.request.urlopen("https://api.vk.com/method/users.get?user_ids="+domain[:len(domain)-1]+"&v=5.52&access_token=b1b6da65b1b6da65b1b6da6547b1c57304bb1b6b1b6da65eefec3e8bb3149f4bcc040dc") as userurl:
    userinfo = json.load(userurl)
for item in userinfo.get('response'):
    personid = str(item.get('id'))        #получаем ID пользователя
    print(personid)
    with urllib.request.urlopen("https://api.vk.com/method/friends.get?user_id="+personid+"&v=5.52&access_token=b1b6da65b1b6da65b1b6da6547b1c57304bb1b6b1b6da65eefec3e8bb3149f4bcc040dc") as friendsurl:
